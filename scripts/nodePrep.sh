...
# Workaround for urllib3 dependency issue. https://bugzilla.redhat.com/show_bug.cgi?id=1497943
yum -y install http://cbs.centos.org/kojifiles/packages/python-urllib3/1.15.1/1.el7/noarch/python-urllib3-1.15.1-1.el7.noarch.rpm
